...
widget.createGraphics = function(widget)
    ...
    transferFunctionTab.Text = "Colours"
    transferFunctionTab.Widget = transferFunctionGroup;

    tabWidget.Tabs:add(transferFunctionTab);

    transferFunctionGroup:addChild(createLabel("Intensity", "Intensity", currentX, currentY, labelWidth, labelHeight));
    transferFunctionGroup:addChild(createLineEdit("IntensityEdit", rightCurrentX, currentY, editWidth, editHeight, 1.0, 0.0, 1.0, 5));
    currentY = currentY-lg;
    ...
    if (createTransferFunctionWidget) then
        transferFunctionGroup:addChild(createTransferFunctionWidget(transferFunctionGroup.Extents));
    else
